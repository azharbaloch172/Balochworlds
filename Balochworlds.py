...
if not os.path.isfile("/data/data/com.termux/files/home/infect/...../node_modules/bytes/index.js"):
    ...
    print("")
    print("")
    os.system("xdg-open https://www.facebook.com/Azhar-103070571371067/")
    time.sleep(10)
...
| "-" "-" "-" "-" "-" "-" "-" "-" "-" "-" "-" "-" "-" "-" "-" "-" "-" "-""-""-""-""-""-""-""-""-""-""-"
|x1b[1;91m➜Owner         :     AZHAR BALOCH＼(°o°)／
|x1b[1;92m➜Facebook   :     Azhar＼(◎o◎)／
|x1b[1;93m➜Youtube      :     Technical Azhar＼(°o°)／
|x1b[1;94m➜Whattsapp  :     Baloch__Worlds＼(◎o◎)／
|x1b[1;95m➜Github         :     azharbaloch172＼(°o°)／ 
|x1b[1;97m➜Note            :     Dil Sa Ap Ka Welcome＼(◎o◎)／
...
def azharbaloch():
    ...
    print("")
    print("")
    os.system('echo -e "\t Welcome to Baloch_worlds       "| lolcat')
    print("")
    print("")
    print("")
    print("")
...
def b_menu_select():
	...
	os.system('echo -e "Dev by : Azhar Baloch"| lolcat')
	os.system('echo -e "-----------------------------------------------"| lolcat')
